    ...
    <header>
        <nav>
            ...
            <div class="nav-links">
                ...
                <a href="../game/gamepage.html"><i class="fas fa-gamepad"></i> Games</a>
                <a href="#leaderboard"><i class="fas fa-trophy"></i> Leaderboard</a>
                <a href="../about/index.html"><i class="fas fa-info-circle"></i> About</a>
                <a href="../contact/contactus.html"><i class="fas fa-envelope"></i> Contact</a>
                <a href="login/login.html" onclick="login()"><i class="fas fa-sign-in-alt"></i> Login</a>
                <a href="../game/sign.html" onclick="signup()"><i class="fas fa-user-plus"></i> Sign Up</a>
